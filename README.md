...
|Version|What                                                                                                                                                                                                           |Status   |
|-------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
|**v1** |On-demand verified briefs (this repo)                                                                                                                                                                          |✅ shipped|
|**v2** |**Agent Scout** — replace the fixed pipeline with a model-driven tool-use loop that decides its own steps, adds a fetch-and-read-the-source tool, and runs under iteration/cost guards. Built with Claude Code.|🔜 next   |
