...
Own the scope completely: a fire at a third-party Delhi facility on June 9 forced an emergency power shutdown that isolated a local Point of Presence. As of June 22, the incident remains active and unresolved 13 days on. The affected surfaces are Hybrid Connectivity, Media CDN, and VPC in asia-south2, with some global impact on those same services. Google has restored a large portion of Internet Edge peering capacity and completed out-of-region peering augmentation in Chennai, with further incremental backbone restoration scheduled for June 23 and the next status update committed by June 23 at 17:00 PDT. Full restoration is still pending; customers may see elevated latency or packet loss until it completes.
