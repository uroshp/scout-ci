...
**"Google is everywhere" is now "Google's everywhere-ness is being dismantled in court" — reframe the distribution objection.**
...
- Perplexity leans on partner bundles to reach users outside its paywall — e.g. Deutsche Telekom's T Phone 3 includes 18 months of Perplexity Pro (\$360 value) free — a distribution workaround against Google's native free reach, but one that creates churn risk when promos expire. ([techradar.com](https://www.techradar.com/pro/one-of-the-worlds-biggest-mobile-firms-has-launched-a-usd170-ai-smartphone-that-includes-a-free-18-month-subs-to-perplexity-pro-worth-usd360-i-wonder-what-happens-on-month-19))
...
It's a legitimate concern — at a \$20B valuation Perplexity is a fraction of Alphabet's ~\$4.5T. But it tripled annualized revenue in 2026 to roughly \$500M ARR, raised ~\$1.5B from SoftBank, Nvidia and others, and counts the bulk of the Fortune 500 as users. The right comparison isn't Perplexity vs Alphabet — it's whether the product survives and delivers ROI over the buyer's horizon, and the trajectory says yes.
