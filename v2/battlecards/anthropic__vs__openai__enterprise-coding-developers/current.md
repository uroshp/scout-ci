...
- On June 25, 2026 the White House asked OpenAI to limit GPT-5.6's initial release to a small group of government-approved customers, with federal officials clearing access customer by customer during a preview period, because they judge the model 'on par' with Anthropic's restricted Mythos. The request came from the Office of the National Cyber Director and the Office of Science and Technology Policy, and Altman told staff in a memo it is 'not our preferred long term model.' It is the first time the US government has preemptively asked an American AI company to restrict a model before release. ([cnn.com](https://www.cnn.com/2026/06/25/tech/openai-limit-release-white-house))
