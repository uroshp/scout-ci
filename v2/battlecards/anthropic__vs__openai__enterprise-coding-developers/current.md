...
- OpenAI announced on August 1, 2026 that an internal version of its next major model, called Astra, produced ten new results on open problems in mathematics and theoretical computer science (including the first construction of a non-sofic group and a disproof of Connes's rigidity conjecture), each formalized as a machine-checkable Lean proof, for roughly \$2,000 in compute at Sol API rates. Astra is unreleased with no launch date, and OpenAI has not said whether it ships as GPT-5.7 or GPT-6. A Fields Medalist, Tim Gowers, had earlier backed a proof from the same model family for publication in the Annals of Mathematics. ([thenextweb.com](https://thenextweb.com/news/openai-astra-model-ten-math-proofs-non-sofic-groups))
...
- Apple sued OpenAI on July 10, 2026 in the US District Court for the Northern District of California, alleging OpenAI systematically stole its hardware trade secrets to build a consumer device. The 41-page complaint names OpenAI, io Products and two former Apple staff, and accuses OpenAI Chief Hardware Officer Tang Tan of directing the theft using Apple codenames in recruiting and asking candidates to bring in Apple parts. Apple says over 400 former Apple employees now work at OpenAI and is seeking an injunction to bar OpenAI from using the material. OpenAI says it has no interest in other companies' trade secrets. ([nbcnews.com](https://www.nbcnews.com/tech/tech-news/apple-sues-openai-two-former-employees-trade-secrets-theft-rcna385916))
