...
On build risk: Claude Sonnet 4.6 and Opus 4.8 were never under the directive and have stayed fully available throughout. Propose standardizing the customer's production stack on Sonnet 4.6 or Opus 4.8 today. The directive's scope covered only Fable 5 and Mythos 5. ([anthropic.com](https://www.anthropic.com/news/fable-mythos-access))
