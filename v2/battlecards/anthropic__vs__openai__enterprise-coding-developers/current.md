...
Real, and the export controls have now been lifted: the June 12 directive suspended Fable 5 and Mythos 5 globally. Senate testimony widened the stated government concern beyond the initial jailbreak incident to Mythos-class autonomous offensive capability. On June 19, President Trump told Axios he no longer views Anthropic as a national security threat, called their response to the Commerce Department order "very responsible," and confirmed that Anthropic technical staff met with administration officials and that he met CEO Dario Amodei at the G7. Trump said he would not shut Anthropic down, though he did not rule out Defense Production Act powers.

On June 26, the Commerce Department partially lifted the restriction on Mythos 5, determining "appropriate safeguards are in place to permit certain trusted partners to access the Claude Mythos 5 Model," and removing the license requirement for more than 100 named US institutions and their foreign national employees. On June 30, Commerce lifted the remaining export controls on both models. Fable 5 returned to global users on the Claude Platform, Claude.ai, Claude Code and Claude Cowork starting July 1, included for up to 50% of weekly usage limits through July 7 on Pro, Max, Team and select Enterprise plans, then available via usage credits. Anthropic also restored Mythos 5 for the set of US organizations approved on June 26, and says it will re-enable Fable 5 on AWS, Google Cloud and Microsoft Foundry as soon as possible.
...
**So what:** Commerce lifted the controls on June 30. Fable 5 is back for global users on the Claude Platform, Claude.ai, Claude Code and Claude Cowork, and Mythos 5 is restored for the approved US organizations. Re-enablement on AWS, Google Cloud and Microsoft Foundry is still pending, so for customers on those clouds, anchor the production stack on Sonnet 4.6 or Opus 4.8, the two models that stayed available throughout. If government access risk is still their core concern, note that OpenAI's newest model is itself restricted to government-approved accounts before launch. ([anthropic.com](https://www.anthropic.com/news/fable-mythos-access))
...
Real, but the underlying driver is now resolved: France's government announced Mistral for its civil service, and Cohere reported a surge of inbound interest after the June 12 export directive restricted Mythos and Fable for foreign nationals. On June 30, the Commerce Department lifted those export controls entirely. Fable 5 returned to global users on the Claude Platform, Claude.ai, Claude Code and Claude Cowork starting July 1, included for up to 50% of weekly usage limits through July 7 on Pro, Max, Team and select Enterprise plans, then available via usage credits, and Mythos 5 was restored for the approved set of US organizations. Claude Opus 4.7 leads SWE-bench Pro at 64.3% and holds the highest developer loyalty score (CSAT 91, NPS 54) in the JetBrains survey.

**So what:** Offer to benchmark the buyer's specific coding workload head-to-head against the alternative they are evaluating. ([anthropic.com](https://www.anthropic.com/news/fable-mythos-access))
