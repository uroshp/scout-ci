...
On June 26, the Commerce Department partially lifted the restriction on Mythos 5. Commerce Secretary Lutnick determined "appropriate safeguards are in place to permit certain trusted partners to access the Claude Mythos 5 Model," and a license is no longer required for more than 100 US institutions named in the letter's Annex A, covering major companies and government agencies, and their foreign national employees. Fable 5 remains restricted; Anthropic says talks to restore it for general use are continuing.
...
**So what:** Propose standardizing the customer's production stack on Sonnet 4.6 or Opus 4.8 as the fully-clear, always-available baseline. If Mythos 5 is in scope for their use case, check whether their organization falls among the 100-plus Annex A institutions where access is now restored. If government access risk is their core concern, the record now shows OpenAI's newest model is itself restricted to government-approved accounts before launch. ([anthropic.com](https://www.anthropic.com/news/fable-mythos-access))
