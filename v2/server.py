...
_CTRL_CSS = (
    ...
    "font-size:13px;color:#5f5e54;white-space:nowrap;border-right:1px solid #dfdbcf;transition:background .15s,color .15s;}"
    ...
    "justify-content:space-between;gap:10px;padding:0 .8rem;font-size:13px;font-weight:500;color:#1c1d16;"
    ...
    ".scout-dd>summary .cv{font-family:'IBM Plex Mono',ui-monospace,monospace;font-size:11px;color:#908e82;transition:transform .15s;}"
    ...
    ".ss-title{font-family:'Fraunces',Georgia,serif;font-weight:600;font-size:26px;margin:.4rem 0 .3rem;}"
    ".ss-cap{font-size:13.5px;color:#5f5e54;line-height:1.5;margin:0 0 1.1rem;}"
    "#ss-form label{display:block;font-size:13px;font-weight:600;color:#33312a;margin:0 0 .9rem;}"
    ...
    ".ss-msg{margin-top:.8rem;font-size:13px;color:#8a6322;min-height:1em;}"
    ...
    ".ss-elapsed{font-family:'IBM Plex Mono',monospace;font-size:11px;color:#908e82;}"
)
